...
@MapperScan(basePackages = "com.render.render_dqc_checkapps.mapper.mysql", sqlSessionFactoryRef = "mysqlSqlSessionFactory")
public class MysqlConfig {
    ...
    private static final String TYPE_ALIASES_PACKAGE = "com.render.render_dqc_checkapps.mysql.*";
